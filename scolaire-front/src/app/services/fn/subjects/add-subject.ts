...
export function addSubject(http: HttpClient, rootUrl: string, params: AddSubject$Params, context?: HttpContext): Observable<StrictHttpResponse<SubjectResponse>> {

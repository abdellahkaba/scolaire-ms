...
export function getAllSessions(http: HttpClient, rootUrl: string, params?: GetAllSessions$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<SessionResponse>>> {

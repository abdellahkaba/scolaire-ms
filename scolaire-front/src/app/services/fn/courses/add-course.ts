...
export function addCourse(http: HttpClient, rootUrl: string, params: AddCourse$Params, context?: HttpContext): Observable<StrictHttpResponse<CourseResponse>> {

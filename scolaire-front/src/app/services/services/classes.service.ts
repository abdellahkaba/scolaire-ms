...
import { listAllClasses } from '../fn/classes/list-all-classes';
import { ListAllClasses$Params } from '../fn/classes/list-all-classes';
import { PageResponseClasseResponse } from '../models/page-response-classe-response';
...
export class ClassesService extends BaseService {
  ...
  /** Path part for operation `listAllClasses()` */
  static readonly ListAllClassesPath = '/classes/by-page';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `listAllClasses()` instead.
   *
   * This method doesn't expect any request body.
   */
  listAllClasses$Response(params?: ListAllClasses$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseClasseResponse>> {
    return listAllClasses(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `listAllClasses$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  listAllClasses(params?: ListAllClasses$Params, context?: HttpContext): Observable<PageResponseClasseResponse> {
    return this.listAllClasses$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageResponseClasseResponse>): PageResponseClasseResponse => r.body)
    );
  }

...
import { listAllPrograms } from '../fn/programs/list-all-programs';
import { ListAllPrograms$Params } from '../fn/programs/list-all-programs';
import { PageResponseProgramResponse } from '../models/page-response-program-response';
...
export class ProgramsService extends BaseService {
  ...
  /** Path part for operation `listAllPrograms()` */
  static readonly ListAllProgramsPath = '/programs/by-page';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `listAllPrograms()` instead.
   *
   * This method doesn't expect any request body.
   */
  listAllPrograms$Response(params?: ListAllPrograms$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseProgramResponse>> {
    return listAllPrograms(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `listAllPrograms$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  listAllPrograms(params?: ListAllPrograms$Params, context?: HttpContext): Observable<PageResponseProgramResponse> {
    return this.listAllPrograms$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageResponseProgramResponse>): PageResponseProgramResponse => r.body)
    );
  }
